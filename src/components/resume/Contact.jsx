...
const Contact = () => {
    ...
    return (
        <div className="contact">
            <h3 className="leftColumnHeading">Contact</h3>
            <hr className='leftHr'></hr>
            <div className="leftColumnGroup">
                ...
                <EditableField initialValue={number} onSave={setNumber} maxLength={"12"} className={className} type={'tel'} side={'left'}/>
            </div>
            <div className="leftColumnGroup">
            <svg viewBox="0 0 24 24" fill="none" className="contact-icon" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                <EditableField initialValue={email} onSave={setEmail} className={className} type={'email'} side={'left'}/>
            </div>
            <div className="leftColumnGroup">
                ...
                <EditableField initialValue={location} onSave={setLocation} className={className} type={'text'} side={'left'}/>
            </div>
            <div className="leftColumnGroup">
                ...
                <EditableField initialValue={website} onSave={setWebsite} className={className} type={'text'} side={'left'} />
            </div>
        </div>
    )
} 
